...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light elevation-4" style="background-color: #8F192F;">
        <!-- Sidebar -->
        <div class="sidebar">
            ...
            <!-- ini mau tak pasang icon admin !!!!!!-->
                ...
                <a href="{{ url('Master') }}" class="d-block" style="color: white; font-size: 15pt; margin-left: 20px; margin-top: 15px;">Master</a>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('Master/pegawai') }}" class="nav-link">
